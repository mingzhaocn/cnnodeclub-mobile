...
export const fetchTopics = (topicsParam: TopicsParam) => (dispatch: Dispatch<TopicsAction>) => {
  ...
  return api.fetchTopics(topicsParam)
    .then(data => dispatch(receiveTopics(data, topicsParam)));
}

export const fetchTopicsIfNeeded = (topicsParam: TopicsParam) => (dispatch:Dispatch<TopicsAction>, getState:Function):any => {
